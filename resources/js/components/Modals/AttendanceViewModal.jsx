                                                    ...
                                                    <tbody>
                                                        {attendanceData?.map((list, index) => {
                                                            ...
                                                            if (list.afternoon_out) {
                                                                ...
                                                                afternoon_in.setHours(13, 0, 0, 0);
                                                                ...
                                                                afternoon_out.setHours(17, 0, 0, 0);
                                                            ...
                                                            return (
                                                                <tr key={index + 1}>
                                                                    <td>{getTime(totalMorningMinutes + totalafternoonMinutes)}</td>
