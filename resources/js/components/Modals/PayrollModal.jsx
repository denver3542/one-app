...
import PayrollSaveModal from './PayrollSaveModal';
...
const PayrollModal = ({ open, close, data, cutoff, type, processtype }) => {
    ...
    return (
        <Dialog open={open} fullWidth maxWidth="lg">
            <DialogTitle className='d-flex justify-content-between'>
                <Typography>Employee Payslip</Typography>
                    ...
                    <div className=" payroll_details pt-10 px-2" ref={contentToPrint} style={{
                        ...
                        <div>
                            <img className="d-flex justify-content-center" src={HomeLogo} style={{
                                height: 100, width: 100, margin: '0 auto', display: 'block'
                            }} />
                            <Typography className='text-center' sx={{ marginBottom: '20px', marginTop: '5px' }}>Nasya Business Consultancy Services Payslip</Typography>
                        </div>
                                    ...
                                    <div className='row'>
                                        <div className='col-6'>
                                            <FormControl sx={{
                                                ...
                                                <input id="demo-simple-select" className='form-control' type="text" defaultValue={data.fname + ' ' + data.mname + ' ' + data.lname} style={{ height: 40 }} />
                                            </FormControl>
                                            <FormControl sx={{
                                                marginBottom: 2, width: '100%', '& label.Mui-focused': {
                                                    color: '#97a5ba',
                                                ...
                                                <input id="demo-simple-select" className='form-control' type="text" defaultValue={data.category} style={{ height: 40 }} />
                                            </FormControl>
                                            <FormControl sx={{
                                                marginBottom: 2, width: '100%', '& label.Mui-focused': {
                                                    color: '#97a5ba',
                                                ...
                                                <input id="demo-simple-select" className='form-control' type="text" defaultValue={data.user_id} style={{ height: 40 }} />
                                            </FormControl>
                                        </div>
                                        <div className='col-6'>
                                            <div className='d-flex justify-content-end'>
                                                <FormControl sx={{
                                                    ...
                                                    <input id="demo-simple-select" className='form-control' type="text" defaultValue={moment(type != 2 ? data.fromDate : data.payroll_fromdate).format('MMM.DD') + ' - ' + moment(type != 2 ? data.todate : data.payroll_todate).format('MMM.DD')} style={{ height: 40 }} />
                                                </FormControl>
                                            </div>
                                            <div className='d-flex justify-content-end'>
                                                <FormControl sx={{
                                                    ...
                                                    <input id="demo-simple-select" className='form-control' type="text" defaultValue={data.workdays + ' days'} style={{ height: 40 }} />
                                                </FormControl>
                                            </div>
                                        </div>
                                    </div>

                                    {type != 2 ? <PayrollSaveModal data={data} close={close} cutoff={cutoff} processtype={processtype} /> : <PayrollUpdateModal data={data} handleToPrint={handleToPrint} close={close} cutoff={cutoff} />}
                                </div>
                            </div>
                        </div>
                    </div>
