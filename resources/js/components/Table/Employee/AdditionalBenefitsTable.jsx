    ...
    <>
      <div>
        ...
        <TablePagination
          ...
          onRowsPerPageChange={handleChangeRowsPerPage} sx={{
      ...
      <HrEmployeeAdditionalBenefitModal open={openModal} close={handleCloseModal} type={1} />
    </>
  )
}

export default AdditionalBenefitsTable