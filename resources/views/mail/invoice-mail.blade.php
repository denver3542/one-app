...
<div style="margin: 10px 5% 10px;background-color: #008018; border-radius: 10px; padding: 5px 5px 5px;">
	...
	<div style="background-color: white">
			...
			<table width="100%" cellspacing="0" cellpadding="20" style=" color: #5a5f61; font-family:verdana;">
					<tr>
							<td ><p><span style="font-size: 0.875rem;">Thank you for entrusting Nasya with your licensure application needs. Enclosed, please find the invoice for the services provided.</span></p><p><span style="font-size: 0.875rem;"><br></span></p><p>Your prompt payment is greatly appreciated. We value our partnership and look forward to supporting you in the future.</p><p><br></p><p>Warm regards,<br><br><span style="font-size: 0.875rem;">Finance Department<br></span><span style="font-size: 0.875rem;">Nasya Business Consultancy Services</span></p>
							</td>
					</tr>
			</table>
