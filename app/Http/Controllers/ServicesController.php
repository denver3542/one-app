...
public function deleteField($id)
{
	...
	{		
		try {
			...
			FinanceField::where('finance_id',$id)->update(['finance_name' => $name, 'finance_value' => $amount, 'finance_currency' => $currency->currency_name, 'finance_privacy' => $privacy]);
