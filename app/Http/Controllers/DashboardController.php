...
class DashboardController extends Controller
{
    ...
    public function getTotals1(Request $request)
    {
		$user = $request->user();
        $user_id = $user->user_id;
        $assign = 0;
        ...
        return response()->json([
            ['title' => 'Members', 'data' => $total_user],
            ['title' => 'Tasks', 'data' => $total_tasks],
            ['title' => 'Contacts', 'data' => $total_contact],
            ['title' => 'Created Contacts', 'data' => $total_contact_created],
            ['title' => 'Inquiries', 'data' => $total_inquiry_contacts],
            ['title' => 'Referrals', 'data' => $total_referrals],
            ['title' => 'Scheduled Calls', 'data' => $total_scheduled_calls],
        ]);
    }
